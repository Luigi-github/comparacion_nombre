<template>
    <form @submit.prevent="handleSubmit" autocomplete="off" novalidate class="flex flex-row mb-5">
        <div class="bg-white">
            <label for="uuid" class="block text-sm font-medium leading-6 text-gray-900">UUID</label>
            <input type="text" id="uuid" maxlength="255" v-model="uuid"
...
export default {
    ...
    methods: {
        async handleSubmit () {
            ...
            apiCall('GET', '/' + data.uuid + '/match-names')
